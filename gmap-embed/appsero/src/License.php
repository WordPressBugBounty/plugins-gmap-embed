...
class License
{
    ...
    public function __construct(Client $client)
    {
        ...
        add_action('wp_ajax_gmap_embed_appsero_refresh_license_' . $this->client->hash, [$this, 'refresh_license_api']);
    ...
    public function menu_output()
    {
        ...
        <div class="wrap appsero-license-settings-wrapper">
            ...
            do_action('gmap_embed_before_appsero_license_section');
            ?>
            ...
            <?php do_action('gmap_embed_after_appsero_license_section'); ?>
        </div>
        <?php
    }
