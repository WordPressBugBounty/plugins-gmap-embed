    ...
    jQuery(document).ready(function ($) {
        ...
        function buildSlide(marker, idx) {
            ...
            return '<div class="swiper-slide">' +
                '<div class="wgm-carousel-card wgm-item-card" data-idx="' + idx + '">' +
                    imageHtml +
        ...
        // Initial Fetch
        $.post(ajaxurl_<?php echo esc_attr($count); ?>, ajaxData_<?php echo esc_attr($count); ?>, function (response) {
            try {
        ...
        $(document).on('click', '#wpgmap_carousel_container_<?php echo esc_attr($count); ?> .wgm-show-on-map-btn', function(e) {
            e.preventDefault();
            e.stopPropagation();
            var idx = $(this).closest('.wgm-carousel-card').data('idx');
            handleShowOnMap(idx);
        });
